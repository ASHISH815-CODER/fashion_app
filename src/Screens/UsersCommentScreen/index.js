                    ...
                    <View style={{ paddingLeft: SCREEN_WIDTH * 0.05, paddingTop: SCREEN_WIDTH * 0.05, paddingRight: SCREEN_WIDTH * 0.05 }} >
                        ...
                        <View style={{ flexDirection: 'row', }}>
                            ...
                            <View style={{}} >
                                ...
                                <Text style={{ color: '#FF2B8A', fontSize: 16, fontFamily: 'montserrat_medium', }} >Letraset sheetscontaining</Text>

                                <Text style={{ opacity: 0.2, fontSize: 10, fontFamily: 'montserrat_medium', }}>@ellefanning</Text>
                        ...
                        <Text style={{ color: '#383838', fontSize: 20, fontFamily: 'montserrat_regular', marginTop: SCREEN_HEIGHT * 0.02 }} >Comments (125)</Text>
                                                    ...
                                                    <View style={{ width: SCREEN_WIDTH * 0.98, }}>
                                                        ...
                                                        <View style={{ flexDirection: 'row', marginTop: SCREEN_HEIGHT * 0.03 }}>
                                                                ...
                                                                <View style={{ flexDirection: 'row', marginTop: SCREEN_HEIGHT * 0.02 }}>
                                                                    <TouchableOpacity >
                                                                        <View style={{ flexDirection: 'row' }} >
                                                                            ...
                                                                            <Text style={{ color: '#444444', fontFamily: 'montserrat_medium', fontSize: 13, }}>Like</Text>
                                                                        </View>
                                                            ...
                                                            /> */}
                                                                            ...
                                                                            <Text style={{ color: '#444444', fontFamily: 'montserrat_medium', fontSize: 13 }}>Comments</Text>
            ...
            <View style={{ position: 'absolute', bottom: 90, alignSelf: 'flex-end', width: SCREEN_WIDTH * 0.9999, height: SCREEN_HEIGHT * 0.1, backgroundColor: "rgba(255,255,255, 0.7)", height: 95, }}>
                ...
                {ShowTypeCommentOptions ?
                    ...
                    <View style={{ position: 'absolute', bottom: 20, alignSelf: 'flex-end', width: SCREEN_WIDTH * 0.9999, height: SCREEN_HEIGHT * 0.1, backgroundColor: "rgba(255,255,255, 0.7)", height: 95, }}>
                        ...
                        <ButtonWithTextInput
                            ButtonTextStyle={{ color: "#fff", fontSize: 13, fontFamily: 'montserrat_medium', }}
                            ButtonStyle={{
                    ...
                    <ButtonWithIcon
                        ...
                        bottonIcon={<Icon name="edit" color="#ffff" size={17} left={10} style={{ marginLeft: 11 }} />}
                    />
